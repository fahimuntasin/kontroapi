    ...
    return (
      <>
        ...
        <style>{`
          ...
          .btn-liquid-lens {
            background-color: ${glassColor || "hsl(var(--foreground) / 5%)"};
            backdrop-filter: blur(8px) url(#liquid-glass-${filterId}) saturate(150%);
            -webkit-backdrop-filter: blur(8px) saturate(150%);
            box-shadow:
              inset 0 0 0 1px hsl(var(--foreground) / 10%),
              inset 1.8px 3px 0px -2px hsl(var(--foreground) / 90%),
              inset -2px -2px 0px -2px hsl(var(--foreground) / 80%),
              inset -3px -8px 1px -6px hsl(var(--foreground) / 60%),
              inset -0.3px -1px 4px 0px hsl(var(--foreground) / 12%),
              inset -1.5px 2.5px 0px -2px hsl(var(--foreground) / 20%),
              inset 0px 3px 4px -2px hsl(var(--foreground) / 20%),
              inset 2px -6.5px 1px -4px hsl(var(--foreground) / 10%),
              0px 1px 5px 0px hsl(var(--foreground) / 10%),
              0px 6px 16px 0px hsl(var(--foreground) / 8%);
