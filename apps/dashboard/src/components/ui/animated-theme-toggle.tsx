...
export function AnimatedThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-border bg-foreground/5 text-foreground transition-all duration-200 hover:bg-accent-blue-soft hover:border-accent-blue-border hover:text-[#3a3fd4] dark:hover:text-[#5c5ff5]"
