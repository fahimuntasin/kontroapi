...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  description = "Access your account and continue building with KontroAPI",
  heroImageSrc,
  testimonials = [],
  onSignIn,
  onGoogleSignIn,
      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" name="rememberMe" className="rounded border-border accent-[#3a3fd4] dark:accent-[#5c5ff5]" />
                  <span className="text-foreground/90">Keep me signed in</span>
                </label>
                <button type="button" onClick={onResetPassword} className="hover:underline text-[#3a3fd4] dark:text-[#5c5ff5] transition-colors">
                  Reset password
                </button>
              </div>
            ...
            <button onClick={onGoogleSignIn} className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors text-foreground">
              <GoogleIcon />
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              New to our platform?{" "}
              <button type="button" onClick={onCreateAccount} className="text-[#3a3fd4] dark:text-[#5c5ff5] hover:underline transition-colors">
                Create Account
              </button>
            </p>
          </div>
