...
export type MessageType = 'text' | 'image' | 'video' | 'audio' | 'document' | 'sticker' | 'location' | 'contact' | 'poll' | 'reaction';
...
export declare const PLAN_SESSION_LIMITS: Record<Plan, number>;
